...
export const StatusDropDown = ({ order, setText, setShowPrompt, setPickedStatus }: any) => {
                                    ...
                                    >
                                        {statusOptions.map((item) => (
                                            <button
                                                ...
                                                className={`-m3 flex items-center rounded-md p-2 transition duration-150 ease-in-out hover:bg-gray-100 ${order?.orderStatus === item.value ? "bg-[rgba(145,158,171,0.16)] font-bold" : ''}`}
                                            >
